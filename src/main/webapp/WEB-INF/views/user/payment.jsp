...
<div class="container-fluid pt-3">
    <form:form action="/user/payment/add" method="POST" modelAttribute="payment">
    <div class="row px-xl-5">
        <div class="col-lg-8">
            <div class="mb-4">
                <h4 class="font-weight-semi-bold mb-4">Dia chi nhan hang</h4>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>Ho va ten</label>
                        <form:input path="nguoiNhan" class="form-control" type="text" placeholder="Bui Thanh Dat"/>
                        <form:errors path="nguoiNhan" cssClass="text-danger"/>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>SDT</label>
                        <form:input path="sdt" class="form-control" type="text" placeholder="+123 456 789"/>
                        <form:errors path="sdt" cssClass="text-danger"/>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Dia chi</label>
                        <form:input path="diaChi" class="form-control" type="text" placeholder="123 Phuong Canh"/>
            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-body">
                    ...
                    <c:forEach items="${listCart}" var="list">
                        <div class="d-flex justify-content-between">
                            <input type="hidden" name="idGioHang" value="${list.idGioHang}"/>
                            <img src="/img/${list.chiTietSanPham.image}" alt="${list.chiTietSanPham.ten}"
                                 style="width: 90px;">
                            <p class="align-middle">#${list.soLuong}</p>
                            <p class="align-middle ml-3"><fmt:formatNumber value="${list.donGia * list.soLuong}"
                    ...
                    <div class="d-flex justify-content-between mb-3 pt-1">
                        ...
                        <h6 class="font-weight-medium"><fmt:formatNumber value="${total}"
                ...
                <div class="card-footer border-secondary bg-transparent">
                    <div class="d-flex justify-content-between mt-2">
                        ...
                        <h5 class="font-weight-bold"><fmt:formatNumber value="${total}"
                                                                       pattern="#,###"></fmt:formatNumber> VND</h5>
                    </div>
                </div>
            </div>
            <div class="card border-secondary mb-5">
...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trinh Van Bo, Ha Noi, Viet Nam</p>
